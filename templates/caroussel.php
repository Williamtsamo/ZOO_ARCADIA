<div id="presentation" class="bg-warning-subtle p-2 text-dark ">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5 mx-auto p-2">
        ...
        <div class="col-lg-6 ">
            <h1 class="display-5 fw-bold text-body-emphasis lh-1 mb-3">Bienvenu au zoo Arcadia</h1>
    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img src="assets/images/herbivores savane.jpg" class="d-block w-50" alt="...">
            </div>
            <div class="carousel-item">
                <img src="assets/images/les singes.jpg" class="d-block w-50" alt="...">
            </div>
        </div>
